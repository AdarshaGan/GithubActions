[![Run App AdarshaGanesan](https://github.com/AdarshaGan/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/AdarshaGan/GithubActions/actions/workflows/run-app.yaml)
